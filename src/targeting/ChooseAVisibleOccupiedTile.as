package targeting 
{
	...
	public class ChooseAVisibleOccupiedTile implements Targeting
	{
		private var minDistance:int;
		private var maxDistance:int;
		public var castAtLocationCallback:Function;
		
		public function ChooseAVisibleOccupiedTile(minDistance:int, maxDistance:int, castAtLocationCallback:Function):void
		{
